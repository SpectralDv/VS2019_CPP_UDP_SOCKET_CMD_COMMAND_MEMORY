...
namespace SpaceControllerInput
{
	...
	{ 
		...
		strcpy_s(this->inputData->name, "ControllerInput");
	}
	ControllerInput::~ControllerInput() 
	{ 
	...
	int ControllerInput::ProcessingMessage()
	{
		...
		strcpy_s(this->command->data, this->inputData->data);
		strcpy_s(str, this->inputData->data);
